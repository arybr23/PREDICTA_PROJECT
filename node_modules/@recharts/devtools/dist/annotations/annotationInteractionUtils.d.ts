 ...
 */
export declare const DEFAULT_CIRCLE_RADIUS = 30;
export declare const DEFAULT_RECT_WIDTH = 60;
export declare const DEFAULT_RECT_HEIGHT = 40;
/**
 ...
 */
export declare function applyAnchorOffset(snap: SnapResult, type: AnnotationType | null, snapMode: SnapMode): SnapResult;
/**
 ...
 */
export declare function isDragInteraction(downPos: {
    x: number;
    y: number;
}, upPos: {
    x: number;
