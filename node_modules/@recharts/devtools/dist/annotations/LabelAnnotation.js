...
export function LabelAnnotation({ annotation }) {
    ...
    return (React.createElement(Label, { value: label.value, position: { x, y }, fill: label.style?.fill ?? color, fontSize: fontSize, fontWeight: fontWeight, opacity: opacity, style: { pointerEvents } }));
}
