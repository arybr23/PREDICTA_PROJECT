...
export const RechartsDevtools = () => {
    ...
    return (React.createElement(React.Fragment, null,
            ...
            createPortal(React.createElement("div", { className: "recharts-devtools", style: { fontFamily: 'monospace', fontSize: '12px' } },
                React.createElement("div", { style: {
                    ...
                    React.createElement("div", { style: { display: 'flex', alignItems: 'center', marginBottom: '4px', gap: '8px' } },
                        React.createElement("label", { htmlFor: selectId }, "Inspect Hook:"),
                        React.createElement("select", { id: selectId, value: selectedInspectorId, onChange: (e) => setSelectedInspectorId(e.target.value), style: { padding: '4px' } }, Object.keys(INSPECTORS).map((key) => (React.createElement("option", { key: key, value: key }, key)))),
        ...
        React.createElement(RechartsAnnotations, null)));
};
