...
const navItems = [
  ...
  },
  {
    ...
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 10.5V6.75m0 3.75 3-3m-3 3-3-3M1.5 12c0-4.56 3.69-8.25 8.25-8.25S18 7.44 18 12s-3.69 8.25-8.25 8.25S1.5 16.56 1.5 12Zm16.5 0h.008v.008H21V12Zm-3 0h.008v.008H18V12Z" />
      </svg>
    ),
  },
  {
