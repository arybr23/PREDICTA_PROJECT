        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-small-title text-text-secondary">Waste Reduced</span>
            </div>
            <span className="text-small-title text-success font-bold">78%</span>
          </div>
          <ProgressBar value={78} max={100} trackClassName="bg-success-light" fillClassName="bg-success" />
          <p className="text-caption text-text-secondary mt-2">Expected spoilage minimized through predictive ordering</p>
        </div>
        <div>
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-small-title text-text-secondary">Financial Saved</span>
            </div>
            <span className="text-small-title text-primary font-bold">Rp450k</span>
          </div>
          <ProgressBar value={72} max={100} trackClassName="bg-primary-light" fillClassName="bg-primary" />
          <p className="text-caption text-text-secondary mt-2">Projected cost savings from waste reduction</p>
        </div>
      </div>
    </Card>
  );
